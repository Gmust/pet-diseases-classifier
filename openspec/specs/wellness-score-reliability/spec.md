# Wellness Score Reliability Specification

## Purpose

Define the reliability, explainability, minimum-data, tracking-guidance, and compatibility contract for `POST /wellness`.
