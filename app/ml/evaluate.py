...
def main() -> None:
    ...
    p.add_argument(
        ...
        "(see app.ml.calibration). Not written unless this is set.",
    )
    p.add_argument(
    ...
    from app.ml.eval_coverage import (
        EvaluationCoverageError,
        build_coverage_report,
        require_full_coverage,
    )
    from app.ml.evaluation_report import (
    ...
    from app.ml.run_metadata import file_fingerprint
    ...
    if args.emit_calibration:
        ...
        from app.ml.run_metadata import git_commit
